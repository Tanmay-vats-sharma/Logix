        ...
        <div className="w-full h-svh flex items-center justify-center">
            <div className='bg-[#1b1c1d] w-11/12 h-3/5 rounded-xl relative overflow-hidden flex items-center justify-center'>
                ...
                <div className='flex flex-col items-center justify-center  h-full w-3/5 p-7 text-[#fff] gap-4 hebrew-text relative'>
                    ...
                    <div className='absolute top-1/2 bottom-auto h-1 w-1 shadow-customShadow z-0 motion-scale-in-[0.01] motion-ease-in-out' />

                    {/* Text */}
                    <div className='w-[75%] motion-scale-in-[0.11] motion-translate-x-in-[0%] motion-translate-y-in-[-104%] motion-ease-spring-smooth motion-duration-[900ms]'>
