...
import CodeEditorPage from "./components/pages/eventPage/CodeEvent/CodeEditor.jsx";
import AdminDashboard from "./components/pages/adminPage/AdminPanel.jsx";
    ...
    <Router>
      <Routes>
        <Route element={<Layout />}>
          ...
          <Route path="/event-editor" element={<CodeEditorPage />} />
          <Route path="/test" element={<AdminDashboard />}></Route>
        </Route>
